...
class ClassificationAlgorithms:
    ...
    def forward_selection(self, max_features, X_train, y_train):
        ...
        for i in range(0, max_features):
            ...
            for f in features_left:
                ...
                # If the performance is better than what we have seen so far (we aim for high accuracy) we set the current feature to the best feature and the same for the best performance.
                if perf > best_perf:
                    best_perf = perf
                    best_feature = f
    ...
    # Apply a neural network for classification upon the training data (with the specified composition of hidden layers and number of iterations), and use the created network to predict the outcome for both the test and training set. It returns the categorical predictions for the training and test set as well as the probabilities associated with each class, each class being represented as a column in the data frame.
    ...
    # Apply a support vector machine for classification upon the training data (with the specified value for C, epsilon and the kernel function), and use the created model to predict the outcome for both the test and training set. It returns the categorical predictions for the training and test set as well as the probabilities associated with each class, each class being represented as a column in the data frame.
    ...
    # Apply a decision tree approach for classification upon the training data (with the specified value for the minimum samples in the leaf, and the export path and files if print_model_details=True) and use the created model to predict the outcome for both the test and training set. It returns the categorical predictions for the training and test set as well as the probabilities associated with each class, each class being represented as a column in the data frame.
    def decision_tree(
        self,
        train_X,
        train_y,
    ...
    # Apply a random forest approach for classification upon the training data (with the specified value for the minimum samples in the leaf, the number of trees, and if we should print some of the details of the model print_model_details=True) and use the created model to predict the outcome for both the test and training set. It returns the categorical predictions for the training and test set as well as the probabilities associated with each class, each class being represented as a column in the data frame.
    def random_forest(
        self,
        train_X,
        train_y,
